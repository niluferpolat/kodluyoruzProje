...
export const getLocations = () => {
    return fetch(`https://api.foursquare.com/v2/venues/explore?categoryId=4d954af4a243a5684765b473&near=corlu&client_id=${CLIENT_ID}&client_secret=${CLIENT_SECRET}&v=202102010`

            ...
            <div className="site-layout-background" style={{ padding: 24, minHeight: 500 }}>
                ...
                >
                    ...
                    <Form.Item
                        name="content"
                    >
                        <TextArea id="content" name="content" placeholder="Eklemek İstedikleriniz(İsteğe Bağlı)" />
                    </Form.Item>
                    ...
                    <Form.Item name="communication"
                        rules={[{ required: true }]}
                    >
                        <Input id="communication" name="communication" placeholder="Email ya da Telefon Numarası Giriniz" />
                    </Form.Item>
                    <Form.Item>

    ...
    return (
        ...
        >
            ...
            <Form.Item
                name="content"
            >
                <TextArea id="content" name="content" defaultValue={adopt?.content} placeholder="Eklemek İstedikleriniz(İsteğe Bağlı)" />
            </Form.Item>
            ...
            <Form.Item name="communication"
                rules={[{ required: true }]}
            >
                <Input id="communication" defaultValue={adopt?.communication} name="communication" placeholder="Email ya da Telefon Numarası Giriniz" />
            </Form.Item>
            <Form.Item>
